...
```bash
cd 
pip install torch-scatter timm laspy[lazrs] munch pandas plyfile pyyaml scikit-learn six tqdm open3d-cpu jakteristics shapely geopandas alphashape spconv tensorboard tensorboardX #spconv-cu120 
cd ~/dev
...
# adjust config
config.forest_path = "/home/fatemeh/dev/pipeline/forests/plot_7_cut.laz"
config.dataset_test.data_root = "/home/fatemeh/dev/pipeline/tiles"
config.tile_generation = True
config.pretrain = "/home/fatemeh/dev/checkpoints/model_weights.pth"
