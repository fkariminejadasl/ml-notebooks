...
```python
# for python path
sys.path.append("/home/dkissling/dev/TreeLearn/tools/pipeline")
config_path = "/home/dkissling/dev/TreeLearn/configs/pipeline/pipeline.yaml"
config.forest_path = "/home/dkissling/data/tree/treelearn/pipeline/forests/plot_7_cut.laz"
config.dataset_test.data_root = "/home/dkissling/data/tree/treelearn/pipeline/forests/tiles"
config.pretrain = "/home/dkissling/data/tree/treelearn/checkpoints/model_weights.pth"
```
...
TreeLearn, SegmentAnyTree, and ForAINet are based on [PointGroup](https://arxiv.org/abs/2004.01658) model.

<!-- It seems https://github.com/SKrisanski/FSCT and https://github.com/philwilkes/TLS2trees are based on each other and use pointnet++. But I'm not sure. -->